MACRO(ADD_QT_DEPENDENCY)
  IF(PROJECT_USE_QT4)
    ...
    SET(PROJECT_QT_LIBS Qt4::QtCore Qt4::QtGui Qt4::QtOpenGL Qt4::QtNetwork Qt4::QtXml Qt4::WebKit)
  ...
  ELSE()
    FOREACH (component "Xml" "Core" "Widgets" "Gui" "OpenGL" "Network" "Concurrent" "WebKitWidgets")
